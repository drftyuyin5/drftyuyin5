...
function theme_ld_meta_tags() {
    ...
    $logo = theme_get_logo(array('default_src' => "np://user.desktop.nicepage.com/Site_7812978/images/icons8-spyware-1001.png?rand=eac2", 'default_url' => ''));
    if (!empty($logo['src'])) {
...
function theme_color_meta_tags() {
    $theme_color = apply_filters('theme_color', '#327ef9');
